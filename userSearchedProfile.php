...
<body>
       <div class = "card">
           <div class = "card-header bg-secondary text-center text-white"><a href = "SendMessage.php" class="text-white" style="text-decoration:none;"><b>SEND MESSAGE</b></a></div>
           </div>
           <div class = "card-body">
